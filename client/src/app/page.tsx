    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            href="/signup"
            className="inline-block px-8 py-4 bg-stone-900 text-white text-lg rounded-md hover:bg-stone-800 transition-colors"
          >
            無料で始める
          </Link>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-stone-700">機能単位で再利用・改善</p>
            </div>
            <div className="text-center">
              <h3 className="text-xl font-bold text-stone-900 mb-4">
                パターン比較
              </h3>
              <p className="text-stone-700">複数案を並べて最適解を発見</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/signup"
              className="px-8 py-4 bg-stone-900 text-white text-lg rounded-md hover:bg-stone-800 transition-colors text-center"
            >
              無料で始める
            </Link>
            <Link
              href="/login"
              className="px-8 py-4 border-2 border-stone-900 text-stone-900 text-lg rounded-md hover:bg-stone-100 transition-colors text-center"
            >
              ログイン
            </Link>
          </div>
